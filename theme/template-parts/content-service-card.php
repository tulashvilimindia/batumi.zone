...
<article id="post-<?php the_ID(); ?>" <?php post_class($card_classes); ?> style="position: relative;" <?php echo $is_promoted && $promotion_priority ? 'data-priority="' . esc_attr($promotion_priority) . '"' : ''; ?>>
    ...
    <div class="service-card-content">
        ...
        <div class="service-card-footer">
            ...
            ?>
                <!-- 1. Call button (top) -->
                <a href="tel:<?php echo esc_attr($phone ?: $whatsapp_number); ?>" class="btn btn-primary btn-sm">
                    <svg class="phone-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- 2. WhatsApp button (middle - mobile only) -->
